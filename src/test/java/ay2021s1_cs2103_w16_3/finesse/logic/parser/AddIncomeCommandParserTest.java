...
public class AddIncomeCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Income expectedIncome = new TransactionBuilder(INTERNSHIP_2)
                .withCategories(VALID_CATEGORY_FOOD_BEVERAGE).buildIncome();
        ...
        Income expectedIncomeMultipleCategories = new TransactionBuilder(INTERNSHIP_2)
                .withCategories(VALID_CATEGORY_FOOD_BEVERAGE, VALID_CATEGORY_WORK).buildIncome();
        assertParseSuccess(parser, TITLE_DESC_INTERNSHIP + AMOUNT_DESC_INTERNSHIP + DATE_DESC_INTERNSHIP
                ...
                new AddIncomeCommand(expectedIncomeMultipleCategories));
    }
