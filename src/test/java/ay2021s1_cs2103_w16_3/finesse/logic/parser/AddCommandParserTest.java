...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Transaction expectedTransaction = new TransactionBuilder(INTERNSHIP_2)
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + TITLE_DESC_INTERNSHIP + AMOUNT_DESC_INTERNSHIP
                + DATE_DESC_INTERNSHIP + CATEGORY_DESC_FOOD_BEVERAGE, new AddCommand(expectedTransaction));
        ...
        Transaction expectedTransactionMultipleTags = new TransactionBuilder(INTERNSHIP_2)
        ...
        assertParseSuccess(parser, TITLE_DESC_INTERNSHIP + AMOUNT_DESC_INTERNSHIP + DATE_DESC_INTERNSHIP
                + CATEGORY_DESC_WORK + CATEGORY_DESC_FOOD_BEVERAGE, new AddCommand(expectedTransactionMultipleTags));
    }

    @Test
    public void parse_optionalFieldsMissing_success() {
        // zero categories
        Transaction expectedTransaction = new TransactionBuilder(BUBBLE_TEA_2).withCategories().build();
