...
public class EditBookmarkIncomeCommandParserTest {

    private static final String CATEGORY_EMPTY = " " + PREFIX_CATEGORY;
    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditBookmarkIncomeCommand.MESSAGE_USAGE);
    private EditBookmarkIncomeCommandParser parser = new EditBookmarkIncomeCommandParser();
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, "1", EditBookmarkIncomeCommand.MESSAGE_NOT_EDITED);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditBookmarkIncomeCommand expectedCommand = new EditBookmarkIncomeCommand(targetIndex, descriptor);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditBookmarkTransactionDescriptorBuilder().withAmount(VALID_AMOUNT_PART_TIME).build();
